...
[project page](https://github.com/mmelnyk/binreplace)) for all related discussions.

If you want to find an area that currently needs improving have a look at the
open issues listed at the
[issues page](https://github.com/mmelnyk/binreplace/issues). This is also the place
 ...
 * What's the version of the tool you used? Please include the output of
   `binreplace version` in your bug report.
...
The repository contains the code written for the project in the directories
`cmd/` and `internal/`.
...
(without having `$GOPATH` set) and `cd` into the directory:
    ...
    $ unset GOPATH
    $ git clone https://github.com/mmelnyk/binreplace
    $ cd binreplace

Then use the `make build` tool to build the tool
